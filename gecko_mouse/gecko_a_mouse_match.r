...
gecko_b<-scanBam('/Users/gerbix/Documents/vikas/gecko_green_monkey/gecko_mouse/mouse_a_20m.bam')
...
write.csv(with_pam,'gecko__mouse_a_with_pam.csv')
write.csv(withoutpam, 'gecko__mousea_without_pam.csv')
