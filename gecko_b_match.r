...
for (i in 1:length(gecko_b[[1]]$rname)){ 
  ...
  #print(as.character(substr(dna[temp,], gecko_b[[1]]$pos[i], (gecko_b[[1]]$pos[i] + 21))))
  #if(gecko_b[[1]]$seq[i] == as.character(substr(dna[temp,], gecko_b[[1]]$pos[i], (gecko_b[[1]]$pos[i] + 19)))){ 
